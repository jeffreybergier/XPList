...
internal struct XPLElement: Identifiable, Hashable {
    var id: Int
    init(_ id: Int) {
        self.id = id
    }
...
internal class XPLCollection: RandomAccessCollection, ObservableObject {
    
    typealias Index = Int
    typealias Element = XPLElement
